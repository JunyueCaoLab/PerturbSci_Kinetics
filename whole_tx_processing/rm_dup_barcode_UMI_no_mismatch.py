...
'''
This script accept a input sorted sam file, a output sam file, then it will remove
...
def rm_dup_samfile(samfile, output_file):
    f1 = open(samfile)
...
if __name__ == "__main__":
    ...
    rm_dup_samfile(samfile, output_file)